...
<head>
    <meta charset="UTF-8">
    <title>@yield('title') - Kasir Warung</title>
    ...
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-800/95 backdrop-blur-lg border-r border-slate-700">
        <div class="flex items-center justify-center h-16 bg-gradient-to-r from-purple-600 to-blue-600">
            <h1 class="text-xl font-bold text-white">
                <i class="fas fa-store mr-2"></i> Kasir Warung
            </h1>
        </div>
        <nav class="mt-8">
            <div class="px-4 space-y-2">
                <a href="{{ route('kasir.index') }}" class="flex items-center px-4 py-3 text-gray-300 hover:text-white hover:bg-slate-700 rounded-lg transition-colors duration-200">
                ...
                <a href="{{ route('kasir.pesanan') }}" class="flex items-center px-4 py-3 text-gray-300 hover:text-white hover:bg-slate-700 rounded-lg transition-colors duration-200">
                    <i class="fas fa-concierge-bell mr-3"></i> Pesanan
                </a>
        ...
        <div class="absolute bottom-4 left-4 right-4">
            ...
            <div class="flex items-center p-4 bg-slate-700 rounded-lg">
                ...
                <div>
                    <p class="text-sm font-medium text-white">Kasir Warung</p>
